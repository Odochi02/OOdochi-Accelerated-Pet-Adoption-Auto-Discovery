 #!/bin/bash
  ...
  #Install New relic
  curl -Ls https://download.newrelic.com/install/newrelic-cli/scripts/install.sh | bash && sudo NEW_RELIC_API_KEY=NRAK-DKQ2N9WXV6A63PVHNF3DRG6SHE6 NEW_RELIC_ACCOUNT_ID=1004789986 NEW_RELIC_REGION=EU /usr/local/bin/newrelic install -y
